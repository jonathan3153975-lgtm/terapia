      ...
      <div class="row g-3">
        ...
        <div class="col-12">
          ...
          <div class="mt-2 d-grid gap-3">
            <?php foreach ($linkedMaterials as $linkedMaterial): ?>
              <?php $materialAssets = $linkedMaterialAssets[(int) $linkedMaterial['id']] ?? []; ?>
              <div class="border rounded p-3 bg-white">
                ...
                <?php if (!empty($linkedMaterial['description_html'])): ?>
                  <div class="mt-3 border rounded p-3 bg-light-subtle" style="max-height: 24vh; overflow:auto;">
                    <?php echo (string) $linkedMaterial['description_html']; ?>
                  </div>
                <?php endif; ?>
                <?php if (!empty($materialAssets)): ?>
                  <div class="mt-3 d-flex flex-wrap gap-2">
                    <?php foreach ($materialAssets as $asset): ?>
