  ...
  <div class="card">
    <div class="card-body">
      <div class="row g-3">
        ...
        <div class="col-md-2"><strong>Depressao:</strong> <?php echo !empty($patient['depression']) ? 'Sim' : 'Nao'; ?></div>
        ...
        <div class="col-md-2"><strong>Hepatite:</strong> <?php echo !empty($patient['hepatitis']) ? 'Sim' : 'Nao'; ?></div>
        ...
        <div class="col-12"><hr class="my-2"><h5 class="mb-1">Vicios</h5></div>
        ...
        <div class="col-md-3"><strong>Ja fez terapia?:</strong> <?php echo !empty($patient['had_therapy']) ? 'Sim' : 'Nao'; ?></div>
