...
<head>
    ...
    <title>Editar Pagamento - <?php echo \Config\Config::APP_NAME; ?></title>
                ...
                <div class="page-header">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Editar #<?php echo $payment['id']; ?></li>
                        </ol>
                    </nav>
                </div>

                <div class="card">
                    <form id="editPaymentForm" method="POST" action="<?php echo \Config\Config::APP_URL; ?>/dashboard.php?action=payments&subaction=update">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="patient_id" name="patient_id" class="form-select" required>
                                        ...
                                        <option value="<?php echo $p['id']; ?>" <?php echo $p['id'] == $payment['patient_id'] ? 'selected' : ''; ?>>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        ...
                                        name="amount"
                                        value="<?php
                                            $v = number_format($payment['amount'], 2, ',', '.');
                                            echo 'R$ ' . $v;
                                        ?>"
                                        required
                                    >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select id="status" name="status" class="form-select" required>
                                        <option value="pending"   <?php echo $payment['status'] === 'pending'   ? 'selected' : ''; ?>>Pendente</option>
                                        <option value="paid"      <?php echo $payment['status'] === 'paid'      ? 'selected' : ''; ?>>Pago</option>
