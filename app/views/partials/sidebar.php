...
<aside class="app-sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <?php elseif ($displayRole === 'patient'): ?>
      ...
      <a class="sidebar-link <?php echo str_starts_with($currentAction, 'gratitude') ? 'active' : ''; ?>" href="<?php echo $appUrl; ?>/patient.php?action=gratitude"><i class="fa-solid fa-heart"></i><span>Diário da gratidão</span></a>
