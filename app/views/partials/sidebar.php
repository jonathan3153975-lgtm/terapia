...
<aside class="app-sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <?php elseif ($displayRole === 'patient'): ?>
      ...
      <a class="sidebar-link <?php echo $currentAction === 'breathing-game' ? 'active' : ''; ?> <?php echo $patientFreeTier ? 'sidebar-link--locked' : ''; ?>" href="<?php echo $appUrl; ?>/patient.php?action=breathing-game"><?php if ($patientFreeTier): ?><i class="fa-solid fa-lock"></i><?php else: ?><i class="fa-solid fa-lungs"></i><?php endif; ?><span>Jogo da respiração</span></a>
