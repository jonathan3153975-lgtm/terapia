...
<aside class="app-sidebar">
  <div class="sidebar-brand">
    ...
    <div class="sidebar-brand-copy">
      ...
      <small class="sidebar-brand-subtitle">Plataforma terapÃªutica</small>
    </div>
  </div>
  ...
  <div class="sidebar-user">
    ...
    <?php if ($isPatientPreview): ?>
      <div class="small text-warning-emphasis mt-1">Modo visualizaÃ§Ã£o do paciente</div>
    <?php endif; ?>
  </div>
  ...
  <nav class="sidebar-nav">
    ...
    <?php elseif ($displayRole === 'therapist'): ?>
      ...
      <a class="sidebar-link <?php echo str_starts_with($currentAction, 'therapist-messages') ? 'active' : ''; ?>" href="<?php echo $appUrl; ?>/dashboard.php?action=therapist-messages"><i class="fa-solid fa-envelope-open-text"></i><span>Mensagens diÃ¡rias</span></a>
      ...
      <a class="sidebar-link <?php echo str_starts_with($currentAction, 'therapist-guided-meditations') ? 'active' : ''; ?>" href="<?php echo $appUrl; ?>/dashboard.php?action=therapist-guided-meditations"><i class="fa-solid fa-headphones"></i><span>MeditaÃ§Ã£o guiada</span></a>
      <a class="sidebar-link <?php echo str_starts_with($currentAction, 'therapist-prayers') ? 'active' : ''; ?>" href="<?php echo $appUrl; ?>/dashboard.php?action=therapist-prayers"><i class="fa-solid fa-hands-praying"></i><span>OraÃ§Ãµes</span></a>
      ...
      <a class="sidebar-link <?php echo str_starts_with($currentAction, 'virtual-tasks') ? 'active' : ''; ?>" href="<?php echo $appUrl; ?>/dashboard.php?action=virtual-tasks"><i class="fa-solid fa-star"></i><span>Tarefas dinÃ¢micas</span></a>
    ...
    <?php elseif ($displayRole === 'patient'): ?>
      ...
      <a class="sidebar-link <?php echo $currentAction === 'my-contents' ? 'active' : ''; ?> <?php echo $patientFreeTier ? 'sidebar-link--locked' : ''; ?>" href="<?php echo $appUrl; ?>/patient.php?action=my-contents"><?php if ($patientFreeTier): ?><i class="fa-solid fa-lock"></i><?php else: ?><i class="fa-solid fa-bookmark"></i><?php endif; ?><span>Meus conteÃºdos</span></a>
      ...
      <a class="sidebar-link <?php echo str_starts_with($currentAction, 'gratitude') ? 'active' : ''; ?> <?php echo $patientFreeTier ? 'sidebar-link--locked' : ''; ?>" href="<?php echo $appUrl; ?>/patient.php?action=gratitude"><?php if ($patientFreeTier): ?><i class="fa-solid fa-lock"></i><?php else: ?><i class="fa-solid fa-heart"></i><?php endif; ?><span>DiÃ¡rio da gratidÃ£o</span></a>
