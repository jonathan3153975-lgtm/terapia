...
<aside class="app-sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <?php elseif ($displayRole === 'patient'): ?>
      ...
      <a class="sidebar-link <?php echo str_starts_with($currentAction, 'devotional') || $currentAction === 'devotionals' ? 'active' : ''; ?> <?php echo $patientFreeTier ? 'sidebar-link--locked' : ''; ?>" href="<?php echo $appUrl; ?>/patient.php?action=devotionals"><?php if ($patientFreeTier): ?><i class="fa-solid fa-lock"></i><?php else: ?><i class="fa-solid fa-sun"></i><?php endif; ?><span>Devocional</span></a>
