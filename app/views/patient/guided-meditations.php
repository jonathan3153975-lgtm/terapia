  ...
  <section class="card guided-list-card">
    <div class="card-body p-4">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        <h4 class="mb-0">Meditacoes guiadas</h4>
        <span class="small text-muted"><?php echo count($meditations ?? []); ?> disponivel(is)</span>
      </div>

      <?php if (empty($meditations)): ?>
        <div class="messenger-empty-state">
          <i class="fa-solid fa-headphones-simple"></i>
          <p class="mb-0">Ainda nao ha meditacoes disponiveis para voce.</p>
        </div>
      <?php else: ?>
        <div class="row g-3">
              ...
              <article class="guided-list-item h-100">
                ...
                >
                  <?php if (empty($meditation['reference_image_path'])): ?>
                    <span><i class="fa-regular fa-image me-1"></i>Sem imagem de referencia</span>
                  <?php endif; ?>
                </div>

                <div class="guided-list-content">
                  <h5 class="mb-2"><?php echo htmlspecialchars((string) ($meditation['title'] ?? 'Meditacao')); ?></h5>
