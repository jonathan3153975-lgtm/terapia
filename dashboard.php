...
match ($action) {
    ...
    'therapist-books' => (new TherapistController())->books(),
    'therapist-books-create' => (new TherapistController())->createBook(),
    'therapist-books-store' => (new TherapistController())->storeBook(),
    'therapist-books-show' => (new TherapistController())->showBook(),
    'therapist-books-edit' => (new TherapistController())->editBook(),
    'therapist-books-update' => (new TherapistController())->updateBook(),
    'therapist-books-delete' => (new TherapistController())->deleteBook(),
    'therapist-books-toggle-publish' => (new TherapistController())->toggleBookPublish(),
    'therapist-books-file' => (new TherapistController())->streamBookPdf(),
    'therapist-teratube' => (new TherapistController())->teraTube(),
    'therapist-teratube-create' => (new TherapistController())->createTeraTubeVideo(),
    'therapist-teratube-store' => (new TherapistController())->storeTeraTubeVideo(),
    'therapist-teratube-show' => (new TherapistController())->showTeraTubeVideo(),
    'therapist-teratube-edit' => (new TherapistController())->editTeraTubeVideo(),
    'therapist-teratube-update' => (new TherapistController())->updateTeraTubeVideo(),
    'therapist-teratube-delete' => (new TherapistController())->deleteTeraTubeVideo(),
    'therapist-teratube-toggle-publish' => (new TherapistController())->toggleTeraTubePublish(),
    'therapist-teratube-file' => (new TherapistController())->streamTeraTubeVideo(),
    'therapist-predefined-tasks' => (new TherapistController())->predefinedTasks(),
    'therapist-predefined-tasks-store' => (new TherapistController())->storePredefinedTask(),
    'therapist-predefined-tasks-update' => (new TherapistController())->updatePredefinedTask(),
    'therapist-predefined-tasks-delete' => (new TherapistController())->deletePredefinedTask(),
    ...
    'therapist-devotionals' => (new TherapistController())->devotionals(),
    'therapist-devotionals-create' => (new TherapistController())->createDevotional(),
    'therapist-devotionals-store' => (new TherapistController())->storeDevotional(),
    'therapist-devotionals-show' => (new TherapistController())->showDevotional(),
    'therapist-devotionals-edit' => (new TherapistController())->editDevotional(),
    'therapist-devotionals-update' => (new TherapistController())->updateDevotional(),
    'therapist-devotionals-delete' => (new TherapistController())->deleteDevotional(),
    'therapist-devotionals-entries-store' => (new TherapistController())->storeDevotionalEntry(),
    'therapist-devotionals-entries-show' => (new TherapistController())->showDevotionalEntry(),
    'therapist-devotionals-entries-edit' => (new TherapistController())->editDevotionalEntry(),
    'therapist-devotionals-entries-update' => (new TherapistController())->updateDevotionalEntry(),
    'therapist-devotionals-entries-delete' => (new TherapistController())->deleteDevotionalEntry(),
    'therapist-prayers' => (new TherapistController())->prayers(),
    'therapist-prayers-store' => (new TherapistController())->storePrayer(),
    'therapist-prayers-update' => (new TherapistController())->updatePrayer(),
    'therapist-prayers-delete' => (new TherapistController())->deletePrayer(),
